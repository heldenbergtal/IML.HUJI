...
def select_polynomial_degree(n_samples: int = 100, noise: float = 5):
    ...
    fig1 = go.Figure()
    fig1.add_trace(go.Scatter(x=X, y=noiseless_y, mode="markers+lines"))
    ...
    fig2.add_trace(go.Scatter(x=[i for i in range(polynomial_degrees)],
                              ...
                              mode="markers"))
    fig2.update_layout(
        title="Mean Validation Error as Function of Polynom Degree",
        xaxis_title="degree",
...
def select_regularization_parameter(n_samples: int = 50,
    ...
    for lam in lamds_range:
        lasso = LassoRegression(lam, optimizer=GradientDescent)
    ...
    fig7.add_trace(go.Scatter(x=lamds_range,
                              ...
                              mode="markers+lines",
                              marker=dict(color='#003f5c'), name="validation"),
                   row=1, col=2)
    fig7.update_layout(
    ...
    lasso = LassoRegression(lam=best_lasso, optimizer=GradientDescent)
    ...
    print(f"Models errors: ridge-{ridge_loss}, lasso-{lasso_loss}, linear-{linear_loss}")

...
if __name__ == '__main__':
    ...
    # ---------------------------------------------------------------------------------------------#
    layer1 = FullyConnectedLayer(n_features, 16, ReLU())
    layer2 = FullyConnectedLayer(16, 16, ReLU())
    layer3 = FullyConnectedLayer(16, n_classes, None)

    loss_fn = CrossEntropyLoss()
    solver = GradientDescent(max_iter=5000, learning_rate=FixedLR(1e-1))

    NeuralNetwork([layer1, layer2, layer3], loss_fn, solver).fit(train_X, train_y)
